...
<html lang="en">
  ...
  <body>
      ...
      <nav class="navbar navbar-expand-lg navbar-light" style="background-color: rgb(255, 255, 255);">
            <h3 class="navbar-brand" style="color: rgb(0, 0, 0);">FLOOD RELIEF</h3>
           ...
           <div class="row no-gutters">
             ...
             <?php include 'admin.php'; ?>
              <form method="POST" action="admin.php">
                    <h1 class="font-weight-bold pt-5">Admin Logo</h1>
                    <p class="para">Sign into your account</p>
                  <div class="form-row">  
                        <div class="col-lg-3">
                              <input type="text" placeholder="Username" class="form-control my-3 p-4" name="username">
                        </div>
                  </div>      
                  <div class="form-row">  
                        <div class="col-lg-3">      
